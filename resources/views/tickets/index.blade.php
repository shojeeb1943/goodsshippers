<x-app-layout>
    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="{{ route('tickets.create') }}" class="inline-flex items-center justify-center px-5 py-2.5 border border-transparent font-bold rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm shadow-indigo-200 transition-all">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        @else
            <div class="text-center py-16 px-6">
                ...
                <div class="mt-8">
                    <a href="{{ route('tickets.create') }}" class="inline-flex items-center px-5 py-3 border border-transparent shadow-sm shadow-indigo-200 text-sm font-bold rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition-colors">
